...
import {Grant} from "../../bluechip/lib/generated/cosmos/authz/v1beta1/authz";
...
export const grantAuthorization = (client: BluechipClient, granter: string, grantee: string, grantParam: GrantParam, broadcastOptions: BroadcastOptions): any => {

...
export function mint(client: BluechipClient, address?: string) {
...
export function waitUntilFunded(client: BluechipClient, address: string): Promise<unknown> {
